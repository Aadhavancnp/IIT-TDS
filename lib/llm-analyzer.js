...
{
  "dataNeeded": ["list of ALL URLs or files mentioned that need to be downloaded/scraped, including relative paths"],
  "analysisType": "description of what analysis is needed (e.g., 'sum column', 'scrape secret code', 'count items')",
